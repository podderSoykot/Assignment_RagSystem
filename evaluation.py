...
class RAGEvaluator:
    ...
    def print_evaluation_report(self):
        ...
        print(f"\nInterpretation:")
        print(f"- Hit@1: {self.results['hit_at_1']*100:.1f}% of queries found the exact match as the top result")
        print(f"- Hit@3: {self.results['hit_at_3']*100:.1f}% of queries found the exact match in top 3 results")
        print(f"- Hit@5: {self.results['hit_at_5']*100:.1f}% of queries found the exact match in top 5 results")
        print(f"- MRR: {self.results['mrr']:.3f} indicates average rank of first relevant result")
